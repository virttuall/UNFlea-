		...
		<div class="container ">
			<form class="form-horizontal" id="msform" role="form"
				...
				<fieldset class="well a">
					...
					<g:set var="foo" value="${g.message(code: 'emailVar')}"
						scope="page" />
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="input-group input-group-lg">
								...
								<span class="input-group-addon " data-toggle="popover"
									...
									name="firstname" placeholder="${foo2}" required />
							</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<input type="file" id="avatar" name="avatar"> <span
								class="help-block" style="margin-left: 60px;"><g:message
									code="format" /></span>
						</div>
	...
	<div class="footer">
		<div class="container">
			<div class="col-xs-5 pull-left">
				<g:link controller="index" action="viewRegister" params="[lang:'en']">
					<asset:image src="USA_ROUND.png" alt="UNFlea+" height="40px"
						width="40px" />
				</g:link>
				<g:link controller="index" action="viewRegister" params="[lang:'es']">
					<asset:image src="SPAIN_ROUND.png" alt="UNFlea+" height="40px"
						width="40px" />
				</g:link>
				<g:link controller="index" action="viewRegister" params="[lang:'fr']">
