						...
						<g:each var="images" in="${product.image}">
							<g:each var="image" in="${images}">
								...
								<div class="margin-gallery col-lg-3 col-md-3 col-sm-4 col-xs-6">
									<li class="img-thumbnail"><a class="openDeleteImage" data-toggle="modal"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="modal-body">
						<g:form class="form-horizontal" id="update" url="[action:'updateData',controller:'product']" method="post">
