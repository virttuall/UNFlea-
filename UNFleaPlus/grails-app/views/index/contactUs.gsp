...
<body>
	...
	<div id="footer">
		<div class="container">
			<ul>
				<p>
					<g:link base="http://localhost:8080/UNFleaPlus/index/viewContactUs" params="[lang:'en']">
						<asset:image src="USA.png" alt="UNFlea+" height="40px"
							width="40px" />
					</g:link>
					<g:link base="http://localhost:8080/UNFleaPlus/index/viewContactUs" params="[lang:'es']">
