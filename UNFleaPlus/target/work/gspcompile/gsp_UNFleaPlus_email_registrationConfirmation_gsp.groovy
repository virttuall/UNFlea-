...
printHtmlPart(6)
invokeTag('createLink','g',6,['controller':("user"),'action':("confirmEmail"),'base':("http://unfleaplus-unfleaplus.rhcloud.com/"),'params':([email: user.email, password:password])],-1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1418059915000L
